...
from demo_common import (base_url, client, required, config, allowed_numbers,
...
def main():
    ...
    try:
        ...
        healthy = health.ok and health.json().get('service') == 'Fasal Mitra Free Demo v2'
    except (requests.RequestException, ValueError):
        healthy = False
    if not healthy:
        print('Demo server not reachable. Start demo_server.py and ngrok http 5000 in separate terminals.')
        return
    ...
    try:
        ...
        print('Keep demo_server.py and ngrok running. Answer the call.')
